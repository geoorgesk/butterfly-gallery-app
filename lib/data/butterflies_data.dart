...
List<Butterfly> getButterflies() {
  return [
    ...
    Butterfly(
      id: 46,
      commonName: "Crimson patch butterfly",
      science: "Chlosyne janais",
      origin: "Brazil",
      imagePath: 'assets/images/butterfly_46.jpg',
      details:
          ' The Crimson Patch (Chlosyne janais) is a vibrant black-and-red butterfly found in Central and South America, known for its striking crimson wing patches.',
      family: "Nymphalidae",
      numberOfIndividuals: 1,
    ),
    Butterfly(
      id: 47,
      commonName: "Common blue bottle butterfly",
      science: "Graphium sarpedon",
      origin: "South and Southeast Asia",
      imagePath: 'assets/images/butterfly_47.jpg',
      details:
          'The Graphium sarpedon (Common Bluebottle) is a swift, graceful butterfly recognized for its shimmering blue-green bands on dark brown wings.',
      family: "Papilionidae",
      numberOfIndividuals: 1,
    ),
    Butterfly(
      id: 48,
      commonName: "Lesser dart butterfly",
      science: "Potanthus omaha",
      origin: "Southeast Asia",
      imagePath: 'assets/images/butterfly_48.jpg',
      details:
          'The Potanthus omaha (Lesser Dart) is a small, fast-flying butterfly with bright orange-yellow wings bordered in dark brown, commonly found in grassy areas.',
      family: "Hesperiidae",
      numberOfIndividuals: 1,
    ),
  ];
